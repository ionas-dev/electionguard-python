...
class Registrar:
    ...
    """The electoral roll containing the list of eligible voters."""
    ...
    nonces: Nonces
    """
    Nonces used in the generation of credentials.
    They will be combined with the voter id to create a unique secret key for each voter.
    """
    ...
    def __init__(
        ...
        seed = seed if seed is not None else rand_q()
        self.nonces = Nonces(seed, f"registrar-{self.registrar_id}-credentials")
        self.credentials = {}
